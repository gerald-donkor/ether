        ...
        <Container>
          <section className="flex min-h-[100dvh] flex-col pt-32 pb-24 md:pt-40 md:pb-32">
            <header className="grid gap-8 md:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] md:items-end md:gap-16">
              {/* No eyebrow: the h1 is already the page name, and repeating it
                  above itself would be a label doing no work. */}
              <h1
              ...
              <p
                ...
                className="hero-in text-text-2 max-w-[50ch] text-[15px] leading-[26px] md:pb-4"
              >
                This page records roles that Ether has made available.
              </p>
            </header>

            <div className="rule mt-16 flex flex-1 flex-col justify-between pt-10 md:mt-24 md:flex-row md:items-end md:gap-16 md:pt-12">
