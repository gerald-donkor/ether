  ...
  return (
    <Container>
      <section className="grid min-h-[100dvh] gap-16 pt-32 pb-24 md:grid-cols-[minmax(0,1.35fr)_minmax(240px,0.65fr)] md:items-center md:gap-20 md:pt-40 md:pb-32">
        <div>
          <p className="text-violet text-[12px] leading-none font-medium tracking-[0.12em] uppercase">
            Grants
          </p>
          <h1 className="text-text mt-8 max-w-[760px] text-[clamp(40px,6vw,60px)] leading-[1.5] tracking-[-0.01em]">
            Ether does not list an open grant program today.
          </h1>
        </div>

        <aside className="border-line border-l pl-6 md:pl-8">
